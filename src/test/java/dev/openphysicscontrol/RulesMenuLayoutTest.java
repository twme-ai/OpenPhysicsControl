...
final class RulesMenuLayoutTest {
    ...
    void centersEveryCurrentRuleGroup() {
        ...
        assertEquals(List.of(1, 2, 3, 5, 6, 7, 10, 11, 12, 14, 15, 16),
            RulesMenu.centeredSlots(12, 0));
        assertEquals(IntStream.range(0, 9).boxed().toList(), RulesMenu.centeredSlots(9, 0));
    }

    @Test
    void usesTheLegacyInspiredThreeRowCategoryLayout() {
        assertEquals(List.of(3, 4, 5, 11, 12, 13, 14, 15, 22), RulesMenu.categorySlots());
    }
