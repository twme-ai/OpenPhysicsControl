...
public enum Rule {
    ...
    PLACED_BLOCK_CONNECTIONS(Group.BUILDING, Material.OAK_FENCE),
    ...
    BLOCK_ORIGIN_EXPLOSIONS(Group.BUILDING, Material.RESPAWN_ANCHOR),
    ...
    SNIFFER_EGG_HATCH(Group.SMALL_PLANTS, Material.SNIFFER_EGG),
    ...
    PLAYER_BLOCK_INTERACTIONS(Group.PLAYERS, Material.LEVER),
    PLAYER_ENTITY_INTERACTIONS(Group.PLAYERS, Material.ITEM_FRAME),
    ...
    HANGING_ENTITY_DETACHMENT(Group.ENTITIES, Material.PAINTING),
